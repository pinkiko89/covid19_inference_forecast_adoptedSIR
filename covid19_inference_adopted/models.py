...
def SIR_with_change_points_neighbor_states(
    new_cases_obs,
    change_points_list,
    ...
    with pm.Model() as model:
        ...
        I_begin_ = []
        for i in range(16):
            I_begin_.append(pm.HalfCauchy(name=f"I_begin_{i}", 
        ...
        for k in range (16): # aktuelles Bundesland
            for j in range(16): # alle anderen Bundesländer 
                ...
                for i, cp in enumerate(change_points_list):
                    ...
                    tr_begin = pm.Normal(
                        name=f"transient_begin_{i}_{j}_{k}",
                        mu=prior_mean,
                ...
                for i, cp in enumerate(change_points_list):
                    tr_len = pm.Lognormal(
                        name=f"transient_len_{i}_{j}_{k}",
                ...
                for tr_begin, tr_len, lambda_after in zip(
                    ...
                    lambda_t__ = mh.smooth_step_function(
                        start_val=0,
                        end_val=1,
                        t_begin=tr_begin,
        ...
        delay_ = []
        for i in range(16):
            delay_.append(pm.Lognormal(  #16x
                name=f"delay_{i}",
                mu=np.log(priors_dict["pr_median_delay"]),
                sigma=priors_dict["pr_sigma_delay"],
            ))
        delay = tt.stack(delay_)

        # prior of the error of observed cases
        sigma_obs_ = []
        for i in range(16):
            sigma_obs_.append(pm.HalfCauchy(
                                      name=f"sigma_obs_{i}", 
                                      beta=priors_dict["pr_beta_sigma_obs"]))  #16x
        sigma_obs = tt.stack(sigma_obs_)
        ...
        for j in range(16):
            if weekends_modulated:
                week_end_factor = pm.Beta(f'weekend_factor_{j}', mu=priors_dict['pr_mean_weekend_factor'],
                ...
                if weekend_modulation_type == 'step':
                    ...
                    offset_rad = pm.VonMises(f'offset_modulation_rad_{j}', mu = 0, kappa = 0.01)
                    offset = pm.Deterministic(f'offset_modulation_{j}', offset_rad/(2*np.pi)*7)
        ...
        for i in range(16):
            ...
            pm.Deterministic(f"lambda_t_{i}", lambda_t[i]) # 16x
            pm.Deterministic(f"new_cases_{i}", new_cases_inferred_eff[i])
            pm.Deterministic(f"new_cases_raw_{i}", new_cases_inferred[i])
    return model
...
def SIR_with_change_points_all_states(
    new_cases_obs,
    change_points_list,
    date_begin_simulation,
    num_days_sim,
    ...
    with pm.Model() as model:
        ...
        S, I, new_I = _SIR_model_all_states(
            lambda_t=lambda_t, mu=mu, S_begin=S_begin, I_begin=I_begin, N=N
        )
        #print(tt.shape(new_I).eval())
...
def is_neighbour(n,m):
    neighbour_mat = [[True,  True,  False, False, False, False, True,  False, False, False, True,  False, False, False, False, False], 
                     [True,  True,  False, False, False, False, True,  False, False, False, False, False, False, False, False, True], #Bay
                     [False, False, True,  True,  False, False, False, False, False, False, False, False, False, False, False, False],  #Berl
                     [False, False, True,  True,  False, False, False, True,  False, False, False, False, True,  True,  False, False], #Brand
                     [False, False, False, False, True,  False, False, False, True,  False, False, False, False, False, False, False], #Brem
                     [False, False, False, False, False, True,  False, False, True,  False, False, False, False, False, True,  False], #Ham
                     [True,  True,  False, False, False, False, True,  False, False, True,  True,  False, False, False, False, True], #Hess
                     [False, False, False, True,  False, False, False, True,  True,  False, False, False, False, False, True,  False], #MeckPo
                     [False, False, False, False, True,  True,  True,  True,  True,  True,  False, False, True,  False, True,  True], #Nieds
                     [False, False, False, False, False, False, True,  False, True,  True,  True,  False, False, False, False, False], #NRW
                     [True,  False, False, False, False, False, True,  False, False, True,  True,  True,  False, False, False, False], #RheP
                     [False, False, False, False, False, False, False, False, False, False, True,  True,  False, False, False, False], #Saar
                     [False, False, False, True,  False, False, False, False, True,  False, False, False, True,  True,  False, True], #SachsA
                     [False, False, False, True,  False, False, False, False, False, False, False, False, True,  True,  False, True], #Sachs
...
def get_lambda_index(n,m):
    #list with all neighboring lambdas
    lambdas = []
    for i in range(16):
        for j in range(16):
            if is_neighbour(i,j):
                lambdas.append("Lambda_" + str(i) + "_" + str(j))
